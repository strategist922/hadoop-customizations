...
package com.ci.backports.avro.mapred;
...
public class AvroSerialization<T> extends Configured 
  ...
  /** Determine which schema to use for deserializing. */
  ...
  public Deserializer<AvroWrapper<T>> getDeserializer(Class<AvroWrapper<T>> c) {
    boolean isKey = AvroKey.class.isAssignableFrom(c);
    return new AvroWrapperDeserializer(
        new SpecificDatumReader<T>(getDeserializerSchema(c)), isKey);
  }
  ...
  /** Determine which schema to use for serializing. */
  ...
  public Serializer<AvroWrapper<T>> getSerializer(Class<AvroWrapper<T>> c) {
    return new AvroWrapperSerializer(
        new SpecificDatumWriter<T>(getSerializerSchema(c)));
  }
