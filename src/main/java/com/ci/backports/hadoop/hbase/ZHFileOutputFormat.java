 ...
 */
package com.ci.backports.hadoop.hbase;
 ...
 */
public class ZHFileOutputFormat extends FileOutputFormat<ImmutableBytesWritable, KeyValue> {
  static Log LOG = LogFactory.getLog(ZHFileOutputFormat.class);
